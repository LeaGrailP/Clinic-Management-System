...
function saveChanges() {
  if (form.value.username.trim() === '') return alert('Username required')

  // Here you could add actual update logic, e.g., an API call
...
function confirmDelete() {
  if (confirm('Are you sure you want to delete your account?')) {
    // Call delete logic here (API, local cleanup, etc.)
    localStorage.removeItem('user')
    localStorage.removeItem('role') // If you stored it separately
